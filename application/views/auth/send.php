  ...
  <body>
    <div class="col d-flex justify-content-center">
      <div class="card" style="width: 32rem;">
        <form class="form-signin formulario" action="<?php echo base_url('dashboard/recuperar/enviar') ?>" method="post">
          <span class="respuesta"></span>
          <h1 class="h3 mb-3 font-weight-normal text-center">RECUPERAR CUENTA</h1>
