                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    <div class="dt-buttons btn-group" style="margin-bottom: 1%;"> 
                                        <a href="<?php echo base_url('dashboard/permisos/agregar') ?>" class="btn btn-primary buttons-copy buttons-html5" tabindex="0" type="button"><span>AGREGAR PERMISO</span></a> 
                                    </div>     
