                ...
                <div class="col-md-6">
                    <div class="card card-secondary">
                        <div class="card-header">
                            ...
                            <div class="card-body"> 
                            <form class="form-horizontal formulario" method="POST" action="<?php echo base_url('dashboard/modulo/proceso/editar') ?>"  accept-charset="utf-8" enctype="multipart/form-data">
