            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal formulario" method="POST" action="<?php echo base_url('dashboard/usuario/proceso/perfil') ?>"  accept-charset="utf-8" enctype="multipart/form-data">
                                    ...
                                    <div class="col">
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $prefil_usuario ?>" name="usuario" maxlength="90" autocomplete="off" placeholder="email@gmail.com">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                <label class="col-form-label" for="fileinput">Imagen de usuario:</label>
