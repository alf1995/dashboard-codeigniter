                ...
                <div class="col-md-6">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">AGREGAR ACCIÓN</h3>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal formulario" method="POST" action="<?php echo base_url('dashboard/accion/proceso/agregar') ?>"  accept-charset="utf-8" enctype="multipart/form-data">
